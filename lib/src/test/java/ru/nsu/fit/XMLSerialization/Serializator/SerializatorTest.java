...
import ru.nsu.fit.XMLSerialization.XMLDeserializator;
...
public class SerializatorTest {
  ...
  @Test
  public void testArraySerialization() throws InstantiationException, ClassNotFoundException, InvalidClassException {
